...
void timer_a0_config(){
    ...
    TIMER_A0->CTL |= (TIMER_A_CTL_MC_OFS + TIMER_A_CTL_MC__UP )|(TIMER_A_CTL_SSEL_OFS + TIMER_A_CTL_TASSEL_2 )| (TIMER_A_CTL_ID_MASK + TIMER_A_CTL_ID_0 )  | (TIMER_A_CTL_IE_OFS + TIMER_A_CTL_IE );       // SMCLK, Up mode
    TIMER_A0->CCR[0] = 10000;    // Value to count to, from lab questions
    TIMER_A0->CCTL[0] = TIMER_A_CCTLN_CCIFG;   // TACCR0 interrupt enabled
